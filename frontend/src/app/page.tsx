      ...
      <div className="grid gap-10 lg:grid-cols-2">
        <section className="space-y-6">
          <p className="inline-flex rounded-full border border-cyan-400/30 bg-cyan-400/10 px-4 py-1 text-sm text-cyan-200">
            Multi-tenant AI receptionist for dental clinics
          </p>
          ...
          <p className="max-w-xl text-lg text-slate-300">
            Built for dental SaaS teams: FAQ RAG, appointment intake, admin dashboards, and a
            drop-in widget for clinic websites.
          </p>
        </section>
        <section className="glass rounded-3xl p-8">
          ...
          <ul className="mt-6 space-y-3 text-slate-300">
            ...
            <li>- FastAPI + OpenAI Agents backend</li>
            <li>- PostgreSQL + pgvector-ready schema</li>
